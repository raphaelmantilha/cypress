...
describe("Should test at a functional level", () => {
  ...
  beforeEach(() => {
    buildEnv();
    cy.login("raphael.mantilha@gmail.com", "senha errada");
  ...
  it("Should update an account", () => {
    cy.route({
      method: "PUT",
      url: "/contas/**", // ** serve para o servidor aceitar qualquer coisa depois da barra
  ...
  it("Should create a transaction", () => {
    cy.route({
      ...
      response: {
        ...
        observacao: null,
        tipo: "REC",
        data_transacao: "2020-07-22T03:00:00.000Z",
        data_pagamento: "2020-07-22T03:00:00.000Z",
        valor: "333.00",
        status: false,
        conta_id: 219827,
        usuario_id: 10809,
  ...
  it("Should get balance", () => {
    cy.route({
      ...
      response: {
        ...
        observacao: null,
        tipo: "REC",
        data_transacao: "2020-07-21T03:00:00.000Z",
        data_pagamento: "2020-07-21T03:00:00.000Z",
        valor: "3500.00",
        status: false,
        conta_id: 219829,
        usuario_id: 10809,
  ...
  it("Should validate data send to create an account", () => {
    ...
    cy.route({
      ...
      onRequest:req=>{
          //console.log(req);
          expect(req.request.body.nome).not.be.empty;
    ...
    cy.inserirConta('Conta de teste');
    //cy.wait('@saveConta').then(res=>console.log(res));
  ...
  it('Shoud test the responsiveness',()=>{
